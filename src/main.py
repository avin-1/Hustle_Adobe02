...
def analyze_documents(doc_paths, persona, job_to_be_done, model):
    ...
    query = f"As a {persona}, my goal is to {job_to_be_done}. Give me only the most relevant sections, key concepts, short methods, and precise step-by-step instructions focused strictly on actions like Create, Make, Help, or Do. Keep it short, accurate, and on-topic only."
